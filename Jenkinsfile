pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/ivyca'                                                 // <------change this
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/codyivymiamioh/ivyca225-lab3-2.git'                   // <------change this
        KUBECONFIG = credentials('ivyca-225')                                             // <------change this
    }
